        <div class="breadcumb-area eight">
            <div class="container">
                <div class="row">
                    <div class="breadcumb">
                        <center><h2>Administracion: Provicia</h2></center>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table class="table">
                                    <tr>
                                        <td colspan="3" class="titulo">
                                            <center><h2>Editar Provincia</h2></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nombre:
                                    ...
                                    <tr>
                                        <td>
                                            <select id="clase" name="pais" class="form-control">
                                                <?php
                                                echo '<option value="'.$id_pais.'">'.$nombre_pais.' - Actual</option> ';
                                                echo $opciones;
                                                ?>
                                            </select>
                                        </td>
                    ...
                    <?php if(!isset($_GET['edit'])) { ?>
                        <table class="table table-striped" style="background-color: #FFFFFF;">
                            <tr>
                                ...
                                <td class="titulo"><center>Pais</center></td>
