        <div class="breadcumb-area eight">
            <div class="container">
                <div class="row">
                    <div class="breadcumb">
                        <center><h2>Administracion: Familias</h2></center>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <center>
                            <form action="?pag=<?php echo $_GET['pag']; ?>&editar=1&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" style="width: 35%;">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <select id="clase" name="suborden" class="form-control">
                                                <?php
                                                echo '<option value="'.$id_suborden.'">'.$nombre_suborden.' - Actual</option> ';
                                                echo $opciones;
                                                ?>
                                            </select>
                                        </td>
                        ...
                        <center>
                            <form action='?pag=<?php echo $_GET['pag']; ?>&nuevo=1' method="POST" enctype="multipart/form-data" style="width: 35%;" >
                                <table class="table">
                                    <tr>
                                        <td colspan="3" class="titulo">
                                            <center><h2>Nueva Familia</h2></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <select id="selectbasic" name="suborden" class="form-control">
                                               <?php echo $opciones; ?>
                                            </select>
                                        </td>
                                    </tr>
                    ...
                    <?php if(!isset($_GET['edit'])) { ?>
                        <table class="table table-striped" style="background-color: #FFFFFF;">
                            <tr>
                                ...
                                <td class="titulo"><center>SubOrden</center></td>
