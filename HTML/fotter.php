                    ...
                    <div class="row">
                       <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                           <div class="widget">
                               ...
                               <ul>
                                   <li><a href="know."><img src="images/footer/icon.png" alt=""> Zooks Experiences</a></li>
                                   <li><a href="plan."><img src="images/footer/icon.png" alt=""> Plan Your Day</a></li>
                                   <li><a href="rate."><img src="images/footer/icon.png" alt=""> Rates & Bookings</a></li>
                                   <li><a href="contact."><img src="images/footer/icon.png" alt=""> How to Get Here</a></li>
                                   <li><a href="sponser."><img src="images/footer/icon.png" alt=""> Animal Sponsor</a></li>
                               </ul>
                           </div>
                       </div> 
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="widget">
                                <div class="footer-menu">
                                    <ul>
                                        <li><a href="rules">Zoo Rules</a></li>
