...
###################################################################
    ...
    $stid = oci_parse($conn, 'select ave.id_ave,especie.nombre especie, ave.nombre_comun nombre, color.nombre color,tipo.nombre tipo, ave.tamano, ave.imagen from ave 
