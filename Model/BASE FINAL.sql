...
DROP TYPE "BL"."MAPA_FILTRO_RECORD";
...
DROP TABLE "BL"."JOB" cascade constraints;
...
DROP PROCEDURE "BL"."SEND_MAIL";
DROP PROCEDURE "BL"."VERIFICAR_CUMPLE";
...
DROP FUNCTION "BL"."GET_AVE_FILTRO";
...
DROP FUNCTION "BL"."GET_MAPA_FILTRO";
...
/
--------------------------------------------------------
--  DDL for Type AVE_FILTRO_RECORD
--------------------------------------------------------

  CREATE OR REPLACE TYPE "BL"."AVE_FILTRO_RECORD" AS TABLE OF T_AVE_FILTRO
...
/
--------------------------------------------------------
--  DDL for Type MAPA_FILTRO_RECORD
--------------------------------------------------------

  CREATE OR REPLACE TYPE "BL"."MAPA_FILTRO_RECORD" AS TABLE OF T_MAPA_FILTRO
...
/
--------------------------------------------------------
--  DDL for Type T_AVE_FILTRO
--------------------------------------------------------

  CREATE OR REPLACE TYPE "BL"."T_AVE_FILTRO" AS OBJECT
(
  "ID_AVE" NUMBER(11,0),
	"IMAGEN" VARCHAR2(100 BYTE),
	"NOMBRE_COMUN" VARCHAR2(100 BYTE),
...
/
--------------------------------------------------------
--  DDL for Type T_MAPA_FILTRO
--------------------------------------------------------

  CREATE OR REPLACE TYPE "BL"."T_MAPA_FILTRO" AS OBJECT
(
  "ID_AVE" NUMBER(11,0),
	"NOMBRE_COMUN" VARCHAR2(100 BYTE),
	"NOMBRE_CIENTIFICO" VARCHAR2(100 BYTE),
...
--------------------------------------------------------
  ...
  TABLESPACE "BL_DATA" ;
   ...
   COMMENT ON COLUMN "BL"."BITACORA"."ID_PERSONA" IS 'Llave for¿nea que relaciona la bit¿cora con el usuario que realiz¿ el cambi¿';
 
   COMMENT ON COLUMN "BL"."BITACORA"."SIGUIENTE" IS 'Nueva contrase¿a del usuario';
 
   COMMENT ON COLUMN "BL"."BITACORA"."ANTERIOR" IS 'Contrase¿a anterior al cambio';
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BL"."SQ_AVE"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 60 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence SQ_JOB
--------------------------------------------------------

   CREATE SEQUENCE  "BL"."SQ_JOB"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BL"."SQ_PUNTOS"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 60 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BL"."SQ_UBICACION"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 120 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('40','21','84','20','Trepador Barreteado','25','14Dendrocolaptes_sanctithomae.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('41','22','84','20','Trepador Cabecirrayado','17','14Lepidocolaptes_souleyetii.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('42','23','87','20','Xenops Común','12','14Xenops_minutus.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('43','24','87','20','Hojarrasquero Gorgianteado','18','14Automolus_ochrolaemus.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('44','25','105','20','Arquitecto Plomizo','16','14Synallaxis_brachyura.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('45','26','80','20','Reinita Mielera','11','14coereba flaveola.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('47','27','55','20','Saltator Gorgianteado','20','14saltator maximus.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('49','28','55','1','Saltator Listado','18','14saltator striatipectus.jpg',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.AVE (ID_AVE,ID_ESPECIE,ID_COLOR,ID_ESTADO,NOMBRE_COMUN,TAMANO,IMAGEN,FECHA_MODIFICACION,USER_MODIFICACION) values ('29','27','87','20','Trepadorcito Pico de Cuña','14','14Glyphorynchus spirurus.jpg',to_date('08/10/17','DD/MM/RR'),'BL');
...
Insert into BL.CANTON (ID_CANTON,ID_PROVINCIA,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('59','5','CA¿AS',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('41','Carmes¿',null,null);
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('44','Granate',null,null);
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('45','Carm¿n ',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('54','Esp¿rrago ',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('60','Azul petrÃ³leo',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('64','Turqu¿',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('88','BorgoÃ±a',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('92','P¿rpura',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('78','Cer¿leo',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('42','BermellÃ³n',to_date('08/10/17','DD/MM/RR'),'BL');
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('52','Verde veron¿s ',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('63','¿?ndigo',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('72','Salm¿n',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('83','¿?mbar',null,null);
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('84','MarrÃ³n',to_date('08/10/17','DD/MM/RR'),'BL');
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('95','S¿samo',null,null);
...
Insert into BL.COLOR (ID_COLOR,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('103','M¿rfil',null,null);
REM INSERTING into BL.CONTINENTE
SET DEFINE OFF;
Insert into BL.CONTINENTE (ID_CONTINENTE,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('1','Am¿rica',null,null);
...
Insert into BL.CONTINENTE (ID_CONTINENTE,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('4','Ocean¿a',null,null);
Insert into BL.CONTINENTE (ID_CONTINENTE,NOMBRE,FECHA_MODIFICACION,USER_MODIFICACION) values ('5','¿?frica',null,null);
...
REM INSERTING into BL.JOB
SET DEFINE OFF;
Insert into BL.JOB (ID_JOB,FECHA) values ('5',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('6',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('7',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('8',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('9',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('10',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('11',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('12',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('13',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('14',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('3',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('4',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('23',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('15',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('16',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('17',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('18',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('19',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('20',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('21',to_date('15/10/17','DD/MM/RR'));
Insert into BL.JOB (ID_JOB,FECHA) values ('22',to_date('15/10/17','DD/MM/RR'));
...
BirdLand, te desea un excelente cumpleaños y te recuerda que toda la comunidad de avisadores de aves, esta para celebrar esta importante fecha.
...
Insert into BL.PERSONA (ID_PERSONA,NOMBRE,APELLIDO,FECHA_NACIMIENTO,EMAIL,PROFESION,TIPO,FOTO,FECHA_MODIFICACION,USER_MODIFICACION) values ('20','Silvia','Calderon',to_date('12/11/96','DD/MM/RR'),'silvi_luc@hotmail.com','Ing.Compu','3','default.png',to_date('15/10/17','DD/MM/RR'),'BL');
...
SET DEFINE OFF;
Insert into BL.PUNTAJE (ID_PUNTAJE,ID_AVISTAMIENTO,ID_PERSONA,FECHA_MODIFICACION,USER_MODIFICACION) values ('46','6','14',to_date('15/10/17','DD/MM/RR'),'BL');
...
SET DEFINE OFF;
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('40',null,'57',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('41',null,'58',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('42',null,'76',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('43',null,'80',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('44',null,'78',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('45',null,'69',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('46',null,'73',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('47',null,'74',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('48',null,'75',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('49',null,'71',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('50',null,'73',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('51',null,'65',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('52',null,'19',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('53',null,'55',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('54',null,'81',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('55',null,'76',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('56',null,'80',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('57',null,'30',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('58',null,'81',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('59',null,'41',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('60',null,'43',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('61',null,'39',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('62',null,'42',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('63',null,'49',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('64',null,'77',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('65',null,'78',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('66',null,'79',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('67',null,'70',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('68',null,'67',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('69',null,'72',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('70',null,'59',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('71',null,'63',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('72',null,'55',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('73',null,'76',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('74',null,'78',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('75',null,'79',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('76',null,'67',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('77',null,'74',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('78',null,'66',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('79',null,'75',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('85','29','25',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('94',null,'72',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('83','29','21',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('84','29','31',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('86',null,'76',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('87',null,'78',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('88',null,'79',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('89',null,'70',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('90',null,'67',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('91',null,'72',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('92',null,'66',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('93',null,'75',to_date('08/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('95',null,'72',to_date('08/10/17','DD/MM/RR'),'BL');
...
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('100','49','21',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('101','49','31',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('102','49','25',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('103','49','23',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('104','49','35',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('105','49','34',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('106','49','26',to_date('15/10/17','DD/MM/RR'),'BL');
Insert into BL.UBICACION (ID_UBICACION,ID_AVE,ID_CANTON,FECHA_MODIFICACION,USER_MODIFICACION) values ('107','49','29',to_date('15/10/17','DD/MM/RR'),'BL');
...
Insert into BL.USUARIO (ID_USUARIO,ID_PERSONA,USUARIO,CONTRASENA,FECHA_MODIFICACION,USER_MODIFICACION,PASS) values ('20','20','silvia','21232f297a57a5a743894a0e4a801fc3',to_date('15/10/17','DD/MM/RR'),'BL','admin');
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "BL"."SEND_MAIL" (p_mail_host in varchar2,p_from in varchar2,p_to in varchar2,p_subject in varchar2,p_message in varchar2)
as
...
/
--------------------------------------------------------
--  DDL for Procedure VERIFICAR_CUMPLE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "BL"."VERIFICAR_CUMPLE" as
begin
  insert into job (id_job,fecha) values (sq_job.nextval,sysdate);       
  commit;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_AVE" RETURN ave_1_record 
    ...
    BEGIN
         FOR I IN (SELECT ID_AVE, ID_ESPECIE, ID_COLOR, ID_ESTADO, NOMBRE_COMUN, TAMANO, IMAGEN  FROM ave ORDER BY NOMBRE_COMUN) LOOP
                l_aves.EXTEND;
...
/
--------------------------------------------------------
--  DDL for Function GET_AVE_FILTRO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "BL"."GET_AVE_FILTRO" RETURN AVE_FILTRO_RECORD
    AS

       l_ave AVE_FILTRO_RECORD := AVE_FILTRO_RECORD();
    BEGIN
         FOR I IN (
           select ave.id_ave,ave.imagen,ave.nombre_comun,genero.nombre ||' ' || especie.nombre nombre_cientifico,ave.id_especie,
           genero.id_genero,familia.id_familia,suborden.id_suborden,orden.id_orden,clase.id_clase, ave.tamano
                        from ave
                        inner join especie on ave.id_especie = especie.id_especie
                        inner join genero on especie.id_genero = genero.id_genero
                        inner join familia on genero.id_familia = familia.id_familia
                        ...
                        inner join tipo on ave.id_estado = tipo.id_tipo) LOOP
                l_ave.EXTEND;
                l_ave(l_ave.COUNT) := (T_AVE_FILTRO(i.id_ave, i.imagen, i.nombre_comun, i.nombre_cientifico,i.id_especie,i.id_genero,i.id_familia,i.id_suborden,i.id_orden,i.id_clase,i.tamano)) ;
       END LOOP;
        RETURN l_ave;
END;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_AVISTAMIENTO" RETURN avistamiento_record
    ...
    BEGIN
         FOR I IN (SELECT ID_AVISTAMIENTO, ID_PERSONA, ID_AVE, LATITUD, LONGITUD,FOTO  FROM avistamiento order by id_avistamiento) LOOP
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_COLOR" RETURN color_record
    ...
    BEGIN
         FOR I IN (SELECT ID_COLOR, NOMBRE  FROM color ORDER BY nombre) LOOP
                l_color.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_CONTINENTE" RETURN continente_record
    ...
    BEGIN
         FOR I IN (SELECT ID_CONTINENTE, NOMBRE FROM continente ORDER BY NOMBRE) LOOP
                l_continente.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_ESPECIE" RETURN especie_record
    ...
    BEGIN
         FOR I IN (SELECT ID_ESPECIE, ID_GENERO, NOMBRE FROM especie ORDER BY NOMBRE) LOOP
                l_especie.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_FAMILIA" RETURN familia_record
    ...
    BEGIN
         FOR I IN (SELECT id_familia, id_suborden, nombre FROM familia ORDER BY NOMBRE) LOOP
                l_familia.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_GENERO" RETURN genero_record
    ...
    BEGIN
         FOR I IN (SELECT id_genero, id_familia, nombre FROM genero ORDER BY NOMBRE) LOOP
                l_genero.EXTEND;
...
/
--------------------------------------------------------
--  DDL for Function GET_MAPA_FILTRO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "BL"."GET_MAPA_FILTRO" RETURN MAPA_FILTRO_RECORD
    AS l_mapa MAPA_FILTRO_RECORD := MAPA_FILTRO_RECORD();
    BEGIN
         FOR I IN (select ave.id_ave,ave.nombre_comun,genero.nombre ||' ' || especie.nombre nombre_cientifico, avistamiento.latitud,avistamiento.longitud,ave.id_especie,
           genero.id_genero,familia.id_familia,suborden.id_suborden,orden.id_orden,clase.id_clase, ave.tamano
                ...
                inner join tipo on ave.id_estado = tipo.id_tipo) LOOP
                l_mapa.EXTEND;
                l_mapa(l_mapa.COUNT) := (T_MAPA_FILTRO(i.id_ave, i.nombre_comun, i.nombre_cientifico,i.latitud,i.longitud,i.id_especie,i.id_genero,i.id_familia,i.id_suborden,i.id_orden,i.id_clase,i.tamano)) ;
       END LOOP;
        RETURN l_mapa;
END;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_ORDEN" RETURN orden_record
    ...
    BEGIN
         FOR I IN (SELECT ID_ORDEN, ID_CLASE, NOMBRE  FROM orden ORDER BY NOMBRE) LOOP
                l_orden.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_PAIS" RETURN pais_record
    ...
    BEGIN
         FOR I IN (SELECT ID_PAIS,ID_CONTINENTE, NOMBRE FROM pais ORDER BY NOMBRE) LOOP
                l_pais.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_PROVINCIA" RETURN provincia_record
    ...
    BEGIN
         FOR I IN (SELECT ID_PROVINCIA, ID_PAIS, NOMBRE FROM provincia ORDER BY ID_PROVINCIA) LOOP
                l_provincia.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_SUBORDEN" RETURN suborden_record
    ...
    BEGIN
         FOR I IN (SELECT ID_SUBORDEN, ID_ORDEN, NOMBRE FROM suborden ORDER BY NOMBRE) LOOP
                l_suborden.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_TIPO" RETURN tipo_record
    ...
    BEGIN
         FOR I IN (SELECT ID_TIPO, NOMBRE FROM tipo ORDER BY NOMBRE) LOOP
                l_tipo.EXTEND;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BL"."GET_USUARIO" RETURN usuario_record
    ...
    BEGIN
         FOR I IN (SELECT ID_USUARIO, ID_PERSONA, USUARIO, CONTRASENA FROM usuario ORDER BY ID_USUARIO) LOOP
                l_usuario.EXTEND;
...
--------------------------------------------------------
  ...
  ALTER TABLE "BL"."JOB" MODIFY ("ID_JOB" NOT NULL ENABLE);
 
  ALTER TABLE "BL"."JOB" MODIFY ("FECHA" NOT NULL ENABLE);
--------------------------------------------------------
